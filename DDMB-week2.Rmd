...
```{r}
par(mfrow=c(1,4))
# please insert your code here x 
```
...
calculate_limits<-function(var){
  IQR <- # please insert your code here
  lower <- # please insert your code here
  upper <- # please insert your code here
  return(list(lower, upper)) # this list contains two values that you can retrieve by [[]]
}
```
